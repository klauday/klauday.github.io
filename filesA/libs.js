let globText = ["Светлое оформление","Темное оформление"];
...
$(document).ready(function(){
	...
	$('#owl-popular').owlCarousel({
		loop:false, rewind:true, dots:false, slideBy:1, autoplay:true, autoplayTimeout:12000, nav:true, margin:20,
		navText:['<span class="fal fa-chevron-circle-left"></span>','<span class="fal fa-chevron-circle-right"></span>'],
		responsive: {0: {items:3, slideBy:1, dots:true, nav:false, margin:10}, 
		470: {items:3, slideBy:1, dots:true, nav:false}, 
		760: {items:4, slideBy:1, dots:true, nav:false}, 
		950: {items:6, slideBy:1, dots:true, nav:false}, 
		1220: {items:7, slideBy:1, dots:false, nav:true, margin:20}}, lazyLoad: true
	});
    
    $('#owl-franchise').owlCarousel({
		loop:false, rewind:true, dots:false, slideBy:1, autoplay:true, autoplayTimeout:12000, nav:true, margin:20,
		navText:['<span class="fal fa-chevron-circle-left"></span>','<span class="fal fa-chevron-circle-right"></span>'],
		responsive: {0: {items:3, slideBy:1, dots:false, nav:false, margin:10}, 
		470: {items:3, slideBy:1, dots:false, nav:false}, 
		760: {items:4, slideBy:1, dots:false, nav:false}, 
		950: {items:6, slideBy:1, dots:false, nav:false}, 
		1220: {items:7, slideBy:1, dots:false, nav:true, margin:20}}, lazyLoad: true
	});
    
    $('.caroufr-prev').on('click', function() {$('#owl-franchise').trigger('prev.owl.carousel');});
	$('.caroufr-next').on('click', function() {$('#owl-franchise').trigger('next.owl.carousel');});
    
    $('#owl-rels').owlCarousel({
		loop:false, rewind:true, dots:false, autoplay:true, autoplayTimeout:12000, nav:true, margin:20,
		navText:['<span class="fal fa-chevron-circle-left"></span>','<span class="fal fa-chevron-circle-right"></span>'],
		responsive: {0: {items:3, slideBy:2, dots:false, nav:false, margin:10}, 
		470: {items:3, slideBy:3, dots:false, nav:false}, 
		760: {items:4, slideBy:4, dots:false, nav:false}, 
		950: {items:6, slideBy:3, dots:false, nav:false}, 
		1220: {items:6, slideBy:3, dots:false, nav:false, margin:20}}, lazyLoad: true
	});
    
    $('.carou-prev').on('click', function() {$('#owl-rels').trigger('prev.owl.carousel');});
	$('.carou-next').on('click', function() {$('#owl-rels').trigger('next.owl.carousel');});
	...
	$('.poster-item__rating').each(function(){
    ...
    /*! init sticky header */
    var hdr = $('#header'), hdrpos = hdr.offset().top; 
    ...
    $('.full__light').click(function(){
		if ( $('.light__overlay').length < 1 ) {
			$('.page__cols--second').prepend('<div class="light__overlay"></div>');
		};
		if( $('body').hasClass('light__off') ) {
           $('.full__light').attr("title", "Включить свет");
        } else if (!$('body').hasClass( "light__off")) {
           $('.full__light').attr("title", "Выключить свет");
        }
		$('body').toggleClass('light__off');
	});	
    ...
    $('.mylists-tabs').each(function(){
        let lis = $(".mylists-tabs li");
        lis.slice(2).wrapAll('<ul class="mylists-tabs_wrap"></ul>');
        $(".mylists-tabs_wrap").before("<li class='mylists-tabs_linkwrap'><a href='javascript:void(0);' class='mylists-tabs_link'>...</a></li>");
    });
    ...
    $('body').on('click', '.mylists-tabs_link', function(e) {
        $(".mylists-tabs_wrap").toggleClass("is_active");        
    });	
    ...
    $('.mylists-tabs_wrap').each(function(){
		if ($(".mylists-tabs_wrap li").hasClass("active")) {
            $(".mylists-tabs_link").addClass("is_active");
        } else {
        	$(".mylists-tabs_link").removeClass("is_active");
        }
	});

   
    
    $('body').on('click', '.mylists-tabs_wrap li', function() {
        $(".mylists-tabs_link").addClass("is_active");
        $(".mylists-tabs > li:not(.mylists-tabs_linkwrap)").removeClass("active");
    });	
    
	$("body").on('click', '.mylists-tabs > li:not(.mylists-tabs_linkwrap)', function() {
        $('.mylists-tabs > li').removeClass('active');
    	$('.mylists-tabs > li:eq(' + $(this).addClass('active').index() + ')').addClass('active');
	});	
    
    $('.my-list-statistics').each(function(){
        if($(this).find('tr').length <= 1){
            $(this).find("tbody").remove();
			$(this).append("<span class='statlist__none-text'>Аниме еще не добавляли в списки</span>");
    	}
	});
    
    $('body').on('click', '.mylists-tabs > li:not(.mylists-tabs_linkwrap)', function() {
        $(".mylists-tabs_link").removeClass("is_active");
        $(".mylists-tabs_wrap li").removeClass("active");
    });	
    ...
    $('body').on('click', '.page__mylist--text', function() {
		$(this).next().toggleClass('is-active');
	});	
    
    $('body').on('click', '.mylists-tabs_guest li', function() {
    ...
    $('.change-color').each(function(){
        let $chc = $(this);
        if( $('body').hasClass('light') ) {
              $(this).attr("title", globText[0]);
        } else if (!$('body').hasClass('light')) {
              $(this).attr("title", globText[1]);
        }
    });
...
function declension(n,o){return n[o%100>4&&o%100<20?2:[2,0,1,1,1,2][o%10<5?o%10:5]]}!function(n){function o(n){return n<10?"0"+n:n}n.fn.showclock=function(){let s=new Date,t=n(this).data("date"),e=(t=new Date(t)).getTime()/1e3-s.getTime()/1e3;if(e<=0||isNaN(e))return this.hide(),this;n(".countdown__wrp").removeClass("hidden");let a=Math.floor(e/86400);e%=86400;let c=Math.floor(e/3600);e%=3600;let i=Math.floor(e/60);e=Math.floor(e%60);let l=declension(["день","дня","дней"],o(a)),d=declension(["час","часа","часов"],o(c)),u=declension(["минута","минуты","минут"],o(i)),r=declension(["секунда","секунды","секунд"],o(e)),h="";0!=a&&(h+="<div class='countdown-container days'>",h+="<div class='countdown-value days-bottom'>"+o(a)+"</div> <div>"+l+"</div>",h+="</div><div class='timer-sep'>:"),h+="</div><div class='countdown-container hours'>",h+="<div class='countdown-value hours-bottom'>"+o(c)+"</div> <div>"+d+"</div>",h+="</div><div class='timer-sep'>:",h+="</div><div class='countdown-container minutes'>",h+="<div class='countdown-value minutes-bottom'>"+o(i)+"</div> <div>"+u+"</div>",h+="</div><div class='timer-sep'>:",h+="</div><div class='countdown-container seconds'>",h+="<div class='countdown-value seconds-bottom'>"+o(e)+"</div> <div>"+r+"</div>",h+="</div>",this.html(h)},n.fn.countdown=function(){let o=n(this);o.showclock(),setInterval(function(){o.showclock()},1e3)}}(jQuery);
...
function changeTheme() {
	if($('body').hasClass('light')) {
		...
		$('.change-color__light').removeClass('is-active');
		$('.change-color__dark').addClass('is-active');
		$('.change-color').attr("title", globText[1]);
		setcookie('theme-class', 'dark');
	} else {
		$('head').append('<link class="theme-light" rel="stylesheet" type="text/css" href="/templates/' + dle_skin + '/css/light.css?v=' + (new Date().getTime()) + '">');
		$('.change-color__dark').removeClass('is-active');
		$('.change-color__light').addClass('is-active');
		$('body').addClass('light');
		$('.change-color').attr("title", globText[0]);
	...
	switch(action_z)
	{
		...
		case 'add_full' :
			...
			$.post(dle_root + "engine/ajax/controller.php?mod=utabs", {action: 'add', newsid: news_id_z, tabid: tab_id_z, userid: user_id_z}, function(data) {
				...
				DLEalert('Аниме "' + news_name_z + '", успешно добавлено в список: "' + tab_name_z + '".', 'Аниме успешно добавлено в список');
		...
		case 'delete' :
			...
			$("body").append("<div id='dlepopup' class='dle-alert' title='Аниме успешно удалено из списка' style='display:none'>Аниме " + news_name_z + ", успешно удалено из списка.</div>");
